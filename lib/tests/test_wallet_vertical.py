...
class TestWalletKeystoreAddressIntegrity(unittest.TestCase):
    ...
    def test_bip39_multisig_seed_bip44_standard(self, mock_write):
        ...
        ks2 = keystore.from_xpub(
            'xpub6D9mmC1euHjT6dVrsfwSeNRPF2oi3cTifXwgnhzAay7RiCmZTtzAPCGPcyYP9NwTn5QvoyYsx7DxSQYc82872dk3pWv1P5om1EC1jAr5jGT')
        self._check_xpub_keystore_sanity(ks2)
        self.assertTrue(isinstance(ks2, keystore.BIP32_KeyStore))
    ...
    def test_bip39_multisig_seed_bip49_p2sh_segwit(self, mock_write):
        ...
        ks2 = keystore.from_xpub(
            'ypub6WnnkE8TGSfWMb6QUVYoVsDRwpCUR98xUg7JnSoVuK7w41UGNViztuCCd8f4mHi6KkUahrh5CnZex1PJNi3oKcSCZ9Lni4huF5FAGouGkuz')
        self._check_xpub_keystore_sanity(ks2)
        self.assertTrue(isinstance(ks2, keystore.BIP32_KeyStore))
