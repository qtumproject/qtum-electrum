...
class ElectrumGui:
    ...
    def print_history(self):
        ...
        for item in self.wallet.get_history():
            ...
            messages.append(format_str % (
                time_str, label, format_satoshis(delta, whitespaces=True), format_satoshis(balance, whitespaces=True)))
    ...
    def network_dialog(self):
        print("use 'qtum-electrum setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'qtum-electrum setconfig' to change your settings")
        return True
